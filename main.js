const toggle = document.querySelector('.pricing__toggle-input');
const price = document.querySelector('.js-price');
const viewCount = document.querySelector('.pricing__views-count');
const slider = document.querySelector('.pricing__slider-input');
const subs = document.querySelector('.pricing__subs');
